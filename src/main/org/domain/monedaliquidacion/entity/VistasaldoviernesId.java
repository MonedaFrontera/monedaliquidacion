...
/**
 * VistasaldoviernesId generated by hbm2java
 */
@Embeddable
public class VistasaldoviernesId implements java.io.Serializable {
	...
	public VistasaldoviernesId() {
	}

	public VistasaldoviernesId(String docupromo, String nombrepromo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VistasaldoviernesId))
			return false;
		VistasaldoviernesId castOther = (VistasaldoviernesId) other;
