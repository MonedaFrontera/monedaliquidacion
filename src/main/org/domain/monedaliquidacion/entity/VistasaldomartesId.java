...
/**
 * VistasaldomartesId generated by hbm2java
 */
@Embeddable
public class VistasaldomartesId implements java.io.Serializable {
	...
	public VistasaldomartesId() {
	}

	public VistasaldomartesId(String docupromo, String nombrepromo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VistasaldomartesId))
			return false;
		VistasaldomartesId castOther = (VistasaldomartesId) other;
