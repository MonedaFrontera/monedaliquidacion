...
/**
 * VistasaldolunesId generated by hbm2java
 */
@Embeddable
public class VistasaldolunesId implements java.io.Serializable {
	...
	public VistasaldolunesId() {
	}

	public VistasaldolunesId(String docupromo, String nombrepromo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VistasaldolunesId))
			return false;
		VistasaldolunesId castOther = (VistasaldolunesId) other;
