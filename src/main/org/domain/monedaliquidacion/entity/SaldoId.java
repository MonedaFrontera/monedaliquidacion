...
/**
 * SaldoId generated by hbm2java
 */
@Embeddable
public class SaldoId implements java.io.Serializable {
	...
	public SaldoId(String documento, Date fecha) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SaldoId))
			return false;
		SaldoId castOther = (SaldoId) other;
